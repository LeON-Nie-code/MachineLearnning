...
class GradientBoosting:
    ...
    def fit(self, train_data, train_target):
        ...
        for t in range(self.T):
            ...
            train_preds = rgs.predict(train_data)
        
            # Save the fitted weak learner
            self.ht.append(rgs)
            
            # Update predictions
            ft += self.learning_rate * train_preds
...
def training_boosting_classifier():
    ...
    for idx, i, tt in zip(product([0, 1], [0, 1, 2]),
        ...
        print("Training Gradient Boosting with n_estimator = {}".format(i))
